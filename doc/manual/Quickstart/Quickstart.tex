...
\begin{itemize}
\item Oracle Java Development Kit (JDK) 7 or later\footnote{\url{http://www.oracle.com/technetwork/java/archive-139210.html}}. %Donde este explicado que hace falta java, exactamente no se que secciï¿½n es.
...
\subsection{Uninstalling Magentix2}

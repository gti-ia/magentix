/**
 * DeregisterProfile.java This file was auto-generated from WSDL by the Apache Axis2 version: 1.4
 * Built on : Apr 26, 2008 (06:25:17 EDT)
 */

package wtp;

/**
 * DeregisterProfile bean class
 */

public class DeregisterProfile implements org.apache.axis2.databinding.ADBBean
{
			...
			throws org.apache.axis2.databinding.ADBException
	{
		...
		org.apache.axiom.om.OMDataSource dataSource =
				new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME)
				{
					...
					{
						DeregisterProfile.this.serialize(MY_QNAME, factory,
								xmlWriter);
					}
				};
			...
			org.apache.axis2.databinding.ADBException
	{
		...
		if (serializeType)
		{
			...
			java.lang.String namespacePrefix =
					registerPrefix(xmlWriter, "http://wtp");
			if ((namespacePrefix != null)
					&& (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":DeregisterProfile", xmlWriter);
			}
			else
			{
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"DeregisterProfile", xmlWriter);
			}
			...
			throws org.apache.axis2.databinding.ADBException
	{
		...
		elementList.add(new javax.xml.namespace.QName("", "AgentID"));
	...
	public static class Factory
	{
		 ...
		 */
		public static DeregisterProfile parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception
		{
			DeregisterProfile object = new DeregisterProfile();
			...
			try
			{
						...
						"http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						{
							nsPrefix =
									fullTypeName.substring(0, fullTypeName
											.indexOf(":"));
						}
						nsPrefix = nsPrefix == null ? "" : nsPrefix;
						
						java.lang.String type =
								fullTypeName.substring(fullTypeName
										.indexOf(":") + 1);
						
						if (!"DeregisterProfile".equals(type))
						{
							// find namespace for the prefix
							java.lang.String nsUri =
									reader.getNamespaceContext()
											.getNamespaceURI(nsPrefix);
							return (DeregisterProfile) wtp.ExtensionMapper
								...
								.equals(reader.getName()))
				{
					...
					object
							.setAgentID(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));

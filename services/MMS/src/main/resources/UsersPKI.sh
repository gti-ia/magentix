...
\033[1mDescription:\033[0m This command will create the Users Public Key Infraestructure. This infrastructure will contain the root certificate authority, and all necesaries certificates for each users.\n
			...
			do
				...
				then 
					...
					then
						...
						echo "***Import an ca_users certificate into User keystore***"
						...
						echo "***Generate an key pair with CN=User_Name and O=Magentix***"

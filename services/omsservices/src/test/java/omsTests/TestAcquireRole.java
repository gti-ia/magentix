...
public class TestAcquireRole extends TestCase {
	...
	public void testAcquireRoleFlat()
	{
		try
		{
			...
			String result = omsInterface.acquireRole(roleName, "plana", "pruebas");
			responseParser.parseResponse(result);
			
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
			...
			result = omsInterface.acquireRole(roleName, "plana", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
	...
	public void testAcquireRoleTeam()
	{
		...
		try
		{
			...
			String result = omsInterface.acquireRole(roleName, "equipo", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
			...
			result = omsInterface.acquireRole(roleName, "equipo", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
	...
	public void testAcquireRoleJerarquia()
	{
		...
		try
		{
			...
			String result = omsInterface.acquireRole(roleName, "jerarquia", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
			...
			result = omsInterface.acquireRole(roleName, "jerarquia", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
	...
	public void testAcquireRolePlana2()
	{
		try
		{
			...
			String result = omsInterface.acquireRole(roleName, "plana2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
			...
			result = omsInterface.acquireRole(roleName, "plana2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
	...
	public void testAcquireRoleEquipo2()
	{
		try
		{
			...
			String result = omsInterface.acquireRole(roleName, "equipo2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
			...
			result = omsInterface.acquireRole(roleName, "equipo2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
	...
	public void testAcquireRoleJerarquia2()
	{
		try
		{
			...
			String result = omsInterface.acquireRole(roleName, "jerarquia2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());
			...
			result = omsInterface.acquireRole(roleName, "jerarquia2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", roleName+ " acquired", responseParser.getDescription());

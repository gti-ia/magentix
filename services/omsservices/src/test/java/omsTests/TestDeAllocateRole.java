...
public class TestDeAllocateRole extends TestCase {
	...
	public void testDeAllocateRole1()
	{
		try
		{
			...
			String result = omsInterface.deallocateRole(role, "virtual", "pruebas2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", role+ " deallocated", responseParser.getDescription());
			
			role = "participant";
			
			result = omsInterface.deallocateRole(role, "virtual", "pruebas2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", role+ " deallocated", responseParser.getDescription());
	...
	public void testAllocateRole2a()
	{
		try
		{
			...
			String result = omsInterface.deallocateRole(role, unit, "pruebas2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", role+ " deallocated", responseParser.getDescription());
			...
			result = omsInterface.deallocateRole(role, unit, "pruebas2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", role+ " deallocated", responseParser.getDescription());
	...
	public void testAllocateRole5()
	{
		try
		{
			...
			String result = omsInterface.deallocateRole(role, unit2, "pruebas2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", role+ " deallocated", responseParser.getDescription());
			...
			result = omsInterface.deallocateRole(role, unit2, "pruebas2", "pruebas");
			responseParser.parseResponse(result);
			assertEquals("El mensaje debe ser el siguiente:", role+ " deallocated", responseParser.getDescription());

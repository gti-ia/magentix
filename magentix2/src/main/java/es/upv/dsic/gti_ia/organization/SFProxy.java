...
public class SFProxy {
	 ...
	 *            QueueAgent
	 * @param agentProvider
	 *            The agent who offers the service
	 * @param URLProfile
	 *            The address this where the profile of the service
	 * @param URLProcess
	 *            The address this where the process of the service
	 * @param ArrayArguments
	 *            Input arguments of the service
	 * @return outputs
	 * @throws Exception
	 */
	public Hashtable<String, String> genericService(QueueAgent agent,
			AgentID agentProvider, String URLProfile, String URLProcess,
			ArrayList<String> ArrayArguments) throws Exception {
	...
	/**
	 * This service deletes the service process kept in the sf database and
	...
	/**
	 * This service deletes the service profile kept in the sf database and
	...
	public Hashtable<AgentID, String> getProcess(QueueAgent agent,
	 ...
	 * @throws Exception
	 */
	public String getProfile(QueueAgent agent, String serviceID)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public String registerProfile(QueueAgent agent,
			ProfileDescription ProfileDescription) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String registerProcess(QueueAgent agent,
			ProcessDescription ProcessDescription) throws Exception {

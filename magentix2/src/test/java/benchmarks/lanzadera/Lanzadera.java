...
*/	
		...
		if (args[1].toString().toLowerCase().equals("emisor")) {
			...
			case 1:
				EmisorBenchmark1 a1 = new EmisorBenchmark1(agent, Integer
						.valueOf(args[3]), Integer.valueOf(args[4]), Integer
						.valueOf(args[5]), Integer.valueOf(args[6]));
				a1.start();
				break;
			case 2:
				EmisorBenchmark2 a2 = new EmisorBenchmark2(agent, Integer
						.valueOf(args[3]), Integer.valueOf(args[4]), Integer
						.valueOf(args[5]), Integer.valueOf(args[6]));
				a2.start();
				break;
			case 3:
				EmisorBenchmark3 a3 = new EmisorBenchmark3(agent, Integer
						.valueOf(args[3]), Integer.valueOf(args[4]), Integer
						.valueOf(args[5]), Integer.valueOf(args[6]));
				a3.start();
				break;
			case 4:
				EmisorBenchmark4 a4 = new EmisorBenchmark4(agent, Integer
						.valueOf(args[3]), Integer.valueOf(args[4]), Integer
						.valueOf(args[5]), Integer.valueOf(args[6]));
				a4.start();
				break;
			...
			switch (Integer.valueOf(args[0].toString())) {
			case 1:
				ReceptorBenchmark1 a1 = new ReceptorBenchmark1(agent);
				a1.start();
				break;
			case 2:
				ReceptorBenchmark1 a2 = new ReceptorBenchmark1(agent);
				a2.start();
				break;
			case 3:
				ReceptorBenchmark1 a3 = new ReceptorBenchmark1(agent);
				a3.start();
				break;
			case 4:
				ReceptorBenchmark1 a4 = new ReceptorBenchmark1(agent);
				a4.start();
				break;
			default:
				System.out.println("Error, Seleccione un bechmark entre 1 y 4");

...
public class DeclareQueue
{
    ...
    public static void main(String[] args)
    {
        ...
        session.exchangeBind("headers_queue_any", "amq.match", "useless", arguments);
        arguments = new HashMap<String, Object>();
        arguments.put("x-match", "all");
        arguments.put("h1", "v1");
        arguments.put("h2", "v2");
        //session.exchangeBind("headers_queue_all", "test.headers", "useless", arguments);
        session.exchangeBind("headers_queue_all", "amq.match", "useless", arguments);
        // confirm completion
        session.sync();

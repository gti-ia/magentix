...
public class ia_FCN_Participant extends protocolInternalAction {
	...
	public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
		...
		if (protocolSteep.compareTo(Protocol_Template.JOIN_STEP)==0){
			...
			String myfactName = getFactoryName(agentConversationID,"FCN",false);
			String inifactName = getFactoryName(agentConversationID,"FCN",true);
			MessageFilter filter = new MessageFilter("performative = CFP AND factoryname = "+inifactName);
			...
			ConvCFactory tmpFactory = fcnp.newFactory(myfactName, filter,null,1, 

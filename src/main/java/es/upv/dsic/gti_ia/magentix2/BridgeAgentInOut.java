...
public class BridgeAgentInOut extends BaseAgent{
	...
	public BridgeAgentInOut(AgentID aid, Connection connection) {
		super(aid, connection);
	}
	
	public void execute(){
		System.out.println("Soy agente pasarela, a la espera de mensajes");
		while(true);
	}
	
	public void onMessage(Session ssn, MessageTransfer xfr){
		ACLMessage msg = receiveACLMessage(xfr);
		//Codigo de parseo de msg y envío hacia el exterior
	}

	public final ACLMessage receiveACLMessage(MessageTransfer xfr){

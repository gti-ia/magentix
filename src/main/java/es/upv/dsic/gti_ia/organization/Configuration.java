...
public class Configuration {
	...
	public Configuration() {
		...
		try {
			properties.loadFromXML(Configuration.class.getResourceAsStream("/"
					+ "ThomasSettings.xml"));
			...
			for (Enumeration<Object> e = properties.keys(); e.hasMoreElements();) {
				...
				if (obj.toString().equalsIgnoreCase("serverName")) {
					...
					password = properties.getProperty(obj.toString());
						...
						"OMSServiceDesciptionLocation")) {
					OMSServiceDesciptionLocation = properties.getProperty(obj
							.toString());
				} else if (obj.toString().equalsIgnoreCase(
						"SFServiceDesciptionLocation")) {
					SFServiceDesciptionLocation = properties.getProperty(obj
							.toString());
				} else if (obj.toString().equalsIgnoreCase(
						"THServiceDesciptionLocation")) {
					THServiceDesciptionLocation = properties.getProperty(obj
							.toString());
				}
			}

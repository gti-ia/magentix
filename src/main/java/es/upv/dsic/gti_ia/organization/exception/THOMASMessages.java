...
public class THOMASMessages {
	...
	public enum MessageID {
		...
		SAME_UNIT,
		/**
		 * Exception message when the profile of the service is not found in
		 * Jena DB.
		 */
		SERVICE_PROFILE_NOT_FOUND,
		/**
		 * Exception message when the URI of the service is not found in Jena
		 * DB.
		 */
		SERVICE_URI_NOT_FOUND,
		/**
		 * Exception message when the search of services does not return any
		 * value.
		 */
		SERVICES_NOT_FOUND,
		/**
	...
	public String getMessage(MessageID id, Object... args) {
		...
		if (id != null) {
			...
			return MessageFormat.format(this.bundle.getString(id.toString()),
					args);

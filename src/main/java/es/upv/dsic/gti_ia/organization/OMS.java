...
public class OMS extends QueueAgent {
	...
	public final URI OWL_S_OMS_SERVICES = URI
	...
	// STRUCTURAL SERVICES
	public final URI OMS_REGISTERUNIT_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "RegisterUnitProfile.owl");
	public final URI OMS_REGISTERUNIT_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "RegisterUnitProcess.owl");
	public final URI OMS_REGISTERUNIT_ID = URI.create(OWL_S_OMS_SERVICES
			+ "RegisterUnitProfile.owl");
	public final URI OMS_REGISTERUNIT_GOAL = URI.create("RegisterUnit");

	public final URI OMS_REGISTERNORM_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "RegisterNormProfile.owl");
	public final URI OMS_REGISTERNORM_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "RegisterNormProcess.owl");
	public final URI OMS_REGISTERNORM_GROUNDING = URI.create(OWL_S_OMS_SERVICES
			+ "RegisterNormGrounding.owl");
	public final URI OMS_REGISTERNORM_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_REGISTERROLE_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "RegisterRoleProfile.owl");
	public final URI OMS_REGISTERROLE_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "RegisterRoleProcess.owl");
	public final URI OMS_REGISTERROLE_GROUNDING = URI.create(OWL_S_OMS_SERVICES
			+ "RegisterRoleGrounding.owl");
	public final URI OMS_REGISTERROLE_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_DEREGISTERUNIT_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "DeregisterUnitProfile.owl");
	public final URI OMS_DEREGISTERUNIT_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "DeregisterUnitProcess.owl");
	public final URI OMS_DEREGISTERUNIT_GROUNDING = URI
			.create(OWL_S_OMS_SERVICES + "DeregisterUnitGrounding.owl");
	public final URI OMS_DEREGISTERUNIT_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_DEREGISTERNORM_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "DeregisterNormProfile.owl");
	public final URI OMS_DEREGISTERNORM_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "DeregisterNormProcess.owl");
	public final URI OMS_DEREGISTERNORM_GROUNDING = URI
			.create(OWL_S_OMS_SERVICES + "DeregisterNormGrounding.owl");
	public final URI OMS_DEREGISTERNORM_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_DEREGISTERROLE_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "DeregisterRoleProfile.owl");
	public final URI OMS_DEREGISTERROLE_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "DeregisterRoleProcess.owl");
	public final URI OMS_DEREGISTERROLE_GROUNDING = URI
			.create(OWL_S_OMS_SERVICES + "DeregisterRoleGrounding.owl");
	public final URI OMS_DEREGISTERROLE_ID = URI.create(OWL_S_OMS_SERVICES
	...
	// DYNAMIC SERVICES
	public final URI OMS_ACQUIREROLE_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "AcquireRoleProfile.owl");
	public final URI OMS_ACQUIREROLE_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "AcquireRoleProcess.owl");
	public final URI OMS_ACQUIREROLE_GROUNDING = URI.create(OWL_S_OMS_SERVICES
			+ "AcquireRoleGrounding.owl");
	public final URI OMS_ACQUIREROLE_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_LEAVEROLE_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "LeaveRoleProfile.owl");
	public final URI OMS_LEAVEROLE_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "LeaveRoleProcess.owl");
	public final URI OMS_LEAVEROLE_GROUNDING = URI.create(OWL_S_OMS_SERVICES
			+ "LeaveRoleGrounding.owl");
	public final URI OMS_LEAVEROLE_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_EXPULSE_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "ExpulseProfile.owl");
	public final URI OMS_EXPULSE_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "ExpulseProcess.owl");
	public final URI OMS_EXPULSE_GROUNDING = URI.create(OWL_S_OMS_SERVICES
			+ "ExpulseGrounding.owl");
	public final URI OMS_EXPULSE_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_INFORMUNIT_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "InformUnitProfile.owl");
	public final URI OMS_INFORMUNIT_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "InformUnitProcess.owl");
	public final URI OMS_INFORMUNIT_GROUNDING = URI.create(OWL_S_OMS_SERVICES
			+ "InformUnitGrounding.owl");
	public final URI OMS_INFORMUNIT_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_INFORMROLE_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "InformRoleProfile.owl");
	public final URI OMS_INFORMROLE_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "InformRoleProcess.owl");
	public final URI OMS_INFORMROLE_GROUNDING = URI.create(OWL_S_OMS_SERVICES
			+ "InformRoleGrounding.owl");
	public final URI OMS_INFORMROLE_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_INFORMAGENTROLE_PROFILE = URI
			.create(OWL_S_OMS_SERVICES + "InformAgentRoleProfile.owl");
	public final URI OMS_INFORMAGENTROLE_PROCESS = URI
			.create(OWL_S_OMS_SERVICES + "InformAgentRoleProcess.owl");
	public final URI OMS_INFORMAGENTROLE_GROUNDING = URI
			.create(OWL_S_OMS_SERVICES + "InformAgentRoleGrounding.owl");
	public final URI OMS_INFORMAGENTROLE_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_INFORMMEMBERS_PROFILE = URI.create(OWL_S_OMS_SERVICES
			+ "InformMembersProfile.owl");
	public final URI OMS_INFORMMEMBERS_PROCESS = URI.create(OWL_S_OMS_SERVICES
			+ "InformMembersProcess.owl");
	public final URI OMS_INFORMMEMBERS_GROUNDING = URI
			.create(OWL_S_OMS_SERVICES + "InformMembersGrounding.owl");
	public final URI OMS_INFORMMEMBERS_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_INFORMROLENORMS_PROFILE = URI
			.create(OWL_S_OMS_SERVICES + "InformRoleNormsProfile.owl");
	public final URI OMS_INFORMROLENORMS_PROCESS = URI
			.create(OWL_S_OMS_SERVICES + "InformRoleNormsProcess.owl");
	public final URI OMS_INFORMROLENORMS_GROUNDING = URI
			.create(OWL_S_OMS_SERVICES + "InformRoleNormsGrounding.owl");
	public final URI OMS_INFORMROLENORMS_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_INFORMROLEPROFILES_PROFILE = URI
			.create(OWL_S_OMS_SERVICES + "InformRoleProfilesProfile.owl");
	public final URI OMS_INFORMROLEPROFILES_PROCESS = URI
			.create(OWL_S_OMS_SERVICES + "InformRoleProfilesProcess.owl");
	public final URI OMS_INFORMROLEPROFILES_GROUNDING = URI
			.create(OWL_S_OMS_SERVICES + "InformRoleProfilesGrounding.owl");
	public final URI OMS_INFORMROLEPROFILES_ID = URI.create(OWL_S_OMS_SERVICES
			+ "InformRoleProfilesProfile.owl#InformRoleProfilesProfile");
	public final URI OMS_INFORMROLEPROFILES_GOAL = URI
			.create("InformRoleProfiles");
	public final URI OMS_INFORMROLEPROFILES_PROVIDER = URI.create("Provider");

	public final URI OMS_INFORMUNITROLES_PROFILE = URI
			.create(OWL_S_OMS_SERVICES + "InformUnitRolesProfile.owl");
	public final URI OMS_INFORMUNITROLES_PROCESS = URI
			.create(OWL_S_OMS_SERVICES + "InformUnitRolesProcess.owl");
	public final URI OMS_INFORMUNITROLES_GROUNDING = URI
			.create(OWL_S_OMS_SERVICES + "InformUnitRolesGrounding.owl");
	public final URI OMS_INFORMUNITROLES_ID = URI.create(OWL_S_OMS_SERVICES
	...
	public final URI OMS_QUANTITYMEMBERS_PROFILE = URI
			.create(OWL_S_OMS_SERVICES + "QuantityMembersProfile.owl");
	public final URI OMS_QUANTITYMEMBERS_PROCESS = URI
			.create(OWL_S_OMS_SERVICES + "QuantityMembersProcess.owl");
	public final URI OMS_QUANTITYMEMBERS_GROUNDING = URI
			.create(OWL_S_OMS_SERVICES + "QuantityMembersGrounding.owl");
	public final URI OMS_QUANTITYMEMBERS_ID = URI.create(OWL_S_OMS_SERVICES
	...
	URI[] OMSServicesProfiles = { OMS_REGISTERUNIT_PROFILE /*
															 * ,OMS_REGISTERROLE_PROFILE,OMS_REGISTERNORM_PROFILE,
															 * OMS_DEREGISTERUNIT_PROFILE,OMS_DEREGISTERROLE_PROFILE,
	...
	URI[] OMSServicesGoals = { OMS_REGISTERUNIT_GOAL /*
														 ...
														 * OMS_DEREGISTERUNIT_GOAL,OMS_DEREGISTERROLE_GOAL,
	...
	URI[] OMSServicesIDs = { OMS_REGISTERUNIT_ID /*
													 ...
													 * OMS_DEREGISTERUNIT_ID,OMS_DEREGISTERROLE_ID,

...
public class TraceError {
	...
	/**
	 * The trace mask does not allow that service to publish or request that
	 * service.
	 */
	public static final int SERVICE_NOT_ALLOWED = 15;
	
	/**
	 * Number of available trace error messages
	 */
	public static final int MAX_TRACE_ERROR = 16;
	...
	/**
	 * Constructor which creates a trace error message with the specified name
	 * and description
	 * 
	 * @param name
	 *            Identifier name of the error message

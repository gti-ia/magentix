...
public class AgentCertificate {
	...
	try {
	    ...
	    if (!reservedNames.contains(agentName) && !existAgent(agentName, username))
	    {
		...
		//Solamente cuando se cree el agente por primera vez.
		if (!existAgent)
		{
		...
		existAgent = false;
		this.registerAgentBD(agentName, username);

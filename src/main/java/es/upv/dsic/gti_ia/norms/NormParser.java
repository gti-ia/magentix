  ...
  final public Norm norm() throws ParseException, InvalidIDException, Exception {
    ...
    try {
      ...
      jj_consume_token(69);
            ...
            String message = l10n.getMessage(MessageID.INVALID_EXPRESSION, pex.currentToken.next.beginLine, pex.currentToken.next.beginColumn, getToken(0)+" "+getToken(1)+" "+getToken(2));
    ...
    try {
      if (jj_2_1(2)) {
        ...
        try {
          ...
          default:
            ...
            throw new ParseException();
                        ...
                        String message = l10n.getMessage(MessageID.INVALID_TARGET_VALUE, pex.currentToken.next.beginLine, pex.currentToken.next.beginColumn,  getToken(1));
        ...
        throw new ParseException();
                ...
                String message = l10n.getMessage(MessageID.INVALID_TARGET_TYPE, pex.currentToken.next.beginLine, pex.currentToken.next.beginColumn, getToken(2));
    ...
    try {
      result = OMSAction();
          {if (true) return result;}
                ...
                String message = l10n.getMessage(MessageID.INVALID_OMS_ACTION, pex.currentToken.next.beginLine, pex.currentToken.next.beginColumn, getNextToken(), expected.toString());
  ...
  String expression = "";
    try {
      if (jj_2_5(2)) {
        ...
        String message = l10n.getMessage(MessageID.INVALID_EXPRESSION, pex.currentToken.next.beginLine, pex.currentToken.next.beginColumn, getNextToken());
                {if (true) throw new InvalidExpressionException(message);}
    }
    throw new Error("Missing return statement in function");
  }
...
*/
  ...
  String param1, param2, param3;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case isRole:
      System.out.println("ENTRO: "+ token.image);

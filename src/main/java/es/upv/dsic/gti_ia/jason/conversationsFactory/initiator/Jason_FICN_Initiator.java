...
public class Jason_FICN_Initiator {
	...
	class EVALUATE_PROPOSALS_Method implements ActionStateMethod {
		...
		public String run(CProcessor myProcessor) {
			...
			FICNConversation conv = (FICNConversation)((ConvCProcessor)myProcessor).getConversation();
	...
	public ConvCFactory newFactory(String name, MessageFilter filter,
		...
		filter = new MessageFilter("performative = REFUSE AND protocol = fipa-iterated-contract-net");
		...
		filter = new MessageFilter("performative = PROPOSE AND protocol = fipa-iterated-contract-net");
		...
		filter = new MessageFilter("performative = FAILURE AND protocol = fipa-iterated-contract-net");
		...
		filter = new MessageFilter("performative = INFORM AND protocol = fipa-iterated-contract-net");

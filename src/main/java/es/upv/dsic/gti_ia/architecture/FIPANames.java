...
/**
 * This class provides a single access point for the set of constants already
 * defined by FIPA. The constants have been grouped by category (i.e. ACLCodecs,
 * Content Languages, MTPs, ...), with one inner class implementing each
 * category.
 * 
 * @author Fabio Bellifemine - TILab
 * @version $Date: 2006-08-30 10:57:51 +0200 (mer, 30 ago 2006) $ $Revision:
 *          5893 $
 */
...
public interface FIPANames {
	...
	/**
	 * Set of constants that identifies the Codec of ACL Messages and that can
	 * be assigned via
	...
	public static interface ACLCodec {
		 ...
		 * 
		 * @see <a href=http://www.fipa.org/specs/fipa00070/XC00070f.html>FIPA
		 *      Spec</a>
		 */
		 ...
		 * 
		 * @see <a href=http://www.fipa.org/specs/fipa00071/XC00071b.html>FIPA
		 *      Spec</a>
		 */
		 ...
		 * 
		 * @see <a href=http://www.fipa.org/specs/fipa00069/XC00069e.html>FIPA
		 *      Spec</a>
		 */
	...
	public static interface InteractionProtocol {
		...
		/**
		 * The Iterated-Fipa-Request interaction protocol. Note that this
		 * protocol is defined in JADE and is not a standard FIPA protocol.
		 */
		public static final String ITERATED_FIPA_REQUEST = "iterated-fipa-request";
	}

	/**
	 * Set of constants that identifies the content languages and that can be
	 * assigned via <code>ACLMessage.setLanguage(FIPANames.ContentLanguage.SL0)
	 * </code>
	 */
	...
	/**
	 * Set of constants that identifies the Ontology of ACL Messages and that
	 * can be assigned via
	...
	public static interface MTP {
		 ...
		 * IIOP-based MTP
		 * 
		 * @see <a href=http://www.fipa.org/specs/fipa00075/XC00075e.html>FIPA
		 *      Spec</a>
		 */
		 ...
		 * WAP-based MTP
		 * 
		 * @see <a href=http://www.fipa.org/specs/fipa00076/XC00076c.html>FIPA
		 *      Spec</a>
		 */
		 ...
		 * HTTP-based MTP
		 * 
		 * @see <a href=http://www.fipa.org/specs/fipa00084/XC00084d.html>FIPA
		 *      Spec</a>
		 */

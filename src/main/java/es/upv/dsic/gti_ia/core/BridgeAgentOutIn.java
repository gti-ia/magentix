	...
	public void execute() {
		...
		*/
			...
			*/	
			...
			/*
			 * Parche: HTTP 1.1 no cierra la conexi�n, por lo que no podemos leer hasta eof.
			 * La soluci�n adoptada es que al final de la lectura, si los bytes leidos son menores
			 * que el tama�o del buffer y adem�s al final se encuentra la cadena "\r\n\r\n" se asume
			 * el final del mensaje.
			 * 
			 * 
			 * 
			 * No funcionar�a este parche, si y solo si: 
			 * 
			 * - El tama�o del mensaje total coincide exactamente con el tama�o del buffer, pues no cortariamos
			 * el mensaje.
			 * 
			 * - El tama�o leido es menor al del buffer y el final del paquete coincide con la cadena \r\n\r\n, pero

...
import java.util.*; 
    ...
    public class ModifyProcessSkeleton{
        ...
        /**
         * ModifyProcess
         * @param modifyProcess contains the service implementation ID, service process and grounding
         * @return response 1:OK otherwise 0
         * @throws
         */
        public wtp.ModifyProcessResponse ModifyProcess( wtp.ModifyProcess modifyProcess )
        {
    		...
    		String queryStringService = "prefix xsd: <http://www.w3.org/2001/XMLSchema#>"
    				...
    				+ "select ?x " 
    				+ "where {" 
    				+ "      ?x service:describedBy <"+modifyProcess.getServiceImplementationID()+">"
    				+ "      }";
    		...
    		QueryExecution qeService = QueryExecutionFactory.create(queryService, m);
			...
			if (DEBUG) {
       		...
       		ConcatFiles(modifyProcess.getServiceModel(),profile);
    		...
    		/*try{
    			...
    			validator.setURL("file:///home/usuario/Escritorio/ThomasSF/ModifyProcess/merge.owl");
    		...
    		if(validationResult == 1){
       		*/
    			String process = modifyProcess.getServiceImplementationID();
    			...
    			String processProfile= GetServiceProfile(urlprocess, processname, m);
    			...
    			m.read(modifyProcess.getServiceModel());
    			m.commit();
         ...
         * @param OntModel m
         */
        public void DeleteProcessInputs(String urlprocess, String processname, String WsdlURL, OntModel m) {
         ...
         * @param OntModel m
         */
        public void DeleteWSDLMessagePart(String urlprocess, String WsdlURL, OntModel m){
         ...
         * @param OntModel m
         */
        public void DeleteWSDLOperation(String urlprocess, String WsdlURL, OntModel m){
         ...
         * @param OntModel m
         */
        public void DeleteProcessOutputs(String urlprocess, String processname, String WsdlURL, OntModel m) {
         ...
         * @param OntModel m
         */ 
        public String GetServiceProfile(String urlprocess, String processname, OntModel m){
         ...
         * @param OntModel m
         */ 
        public String GetServiceGrounding(String urlprocess, String processname, String processProfile, OntModel m){
         ...
         * @param OntModel m
         */ 
        public String GetServiceWSDLGrounding(String urlprocess, String processGround, OntModel m){
         ...
         * @param OntModel m
         */ 
        String GetServiceWSDLGroundingDoc(String urlprocess, String processGroundWSDL, OntModel m){
         ...
         * @param OntModel m
         */ 
		void DeleteProcessGrounding(String urlprocess, String processname, String processGround, String processGroundWSDL, OntModel m){
    	...
    	void ConcatFiles(String process, String profile){
    		...
    		try {
    			...
    			BufferedWriter out = new BufferedWriter(new FileWriter("/home/usuario/Escritorio/ThomasSF/ModifyProcess/merge.owl"));
    			...
    			while ((inputLine = in.readLine()) != null){
    				if(!inputLine.contains("</rdf:RDF>"))
    					if (inputLine.contains("<service:presents")){
    			...
    			// Analyze the lines in the bufferReader
    			// and transform them into string lines 
    			System.out.println("antes de lo del profile");
    			while ((inputLine = in.readLine()) != null){
    				System.out.println("en el bucle: "+inputLine);
    				if (inputLine.contains("<profile:")||inputLine.contains("</profile:")){
    					inputText = inputText + inputLine;
    					System.out.println("Estoy a�adiendo las lineas del profile");
    				}

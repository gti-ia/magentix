...
public class RemoveProviderSkeleton{
	...
	public wtp.RemoveProviderResponse RemoveProvider(wtp.RemoveProvider removeProvider)
	{
		...
		String serviceProfile=removeProvider.getServiceProfile().trim();
		String providerID=removeProvider.getProviderID().trim();
...
//		}
		...
		if(DEBUG){
			...
			System.out.println("\tproviderName: "+providerID);
		}
		
		String result = sfInterface.removeProvider(serviceProfile, providerID);

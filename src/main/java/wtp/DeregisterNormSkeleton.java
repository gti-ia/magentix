/**
 * DeregisterNormSkeleton.java This file was auto-generated from WSDL by the Apache Axis2 version:
...
public class DeregisterNormSkeleton
{
	...
	/**
	 * Service used for deleting a norm. The norm must exist and the agent must be a member of
	 * THOMAS (organization 'virtual').
	 * @param deregisterNorm containing:
	 * - NormID
	 * - AgentID
	 */

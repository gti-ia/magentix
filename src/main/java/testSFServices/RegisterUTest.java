...
public class RegisterUTest {
	...
	/**
	 * Register the web service SumArray, which is provided by one organization
	...
	/**
	 * Adding a new provider to a registered service. Concretely, a new agent
	 * provider will be added to the service Square. In order to obtain this,
	 * the OWL-S service specification will be properly changed.
	 * 
	 * @return
	 */
	...
	/**
	 * Adding a new grounding to a registered service. Concretely, the service
	 * Product will be also provided by a web service. In order to obtain this,
	 * the OWL-S service specification will be properly changed.
	 * 
	 * @return
	 */

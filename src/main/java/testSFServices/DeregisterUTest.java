...
public class DeregisterUTest {
	...
	/**
	 * Deregister the web service SumArray, which is provided by one
	 * organization by means of an agent.
	 * 
	 * @return
	 */
	String appropiateParamsTest1() {
		...
		return sf
				.deregisterService("http://localhost:8080/testSFservices/testSFservices/owl/owls/SumArray.owl#SumArrayProfile");
	}
	...
	/**
	 * Try to deregister a service already deregistered. In this case, the
	 * program tries to deregister another time the services SumArray, Product
	 * and Division.
	 * 
	 * @return
	 */

...
public class TesterArgCAgentExperts extends SingleAgent {
	 ...
	 * @throws Exception
	 */
	public TesterArgCAgentExperts(AgentID aid, ArrayList<SocialEntity> socialEntities, String commitmentStoreID,
	...
	public void execute() {
		...
		try {
			...
			try {
				Thread.sleep(2000); // wait until agents are finished
			} catch (InterruptedException e) {
				e.printStackTrace();
			}

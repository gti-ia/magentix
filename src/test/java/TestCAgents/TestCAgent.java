...
public class TestCAgent extends TestCase{
	...
	public void setUp() throws Exception{
		...
		try {
			...
			*/	
			 ...
			 */
			helloWorldAgent = new HelloWorldAgentClass(new AgentID("helloWorldAgent"));
	...
	public void testWelcomeMessage(){
		...
		assertEquals(helloWorldAgent.getName() + ": the welcome message is Welcome to this platform"
	...
	public void testFinalizeMessage(){
		...
		assertEquals(helloWorldAgent.getName() + ": the finalize message is See you"

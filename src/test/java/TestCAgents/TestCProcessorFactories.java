...
/**
 * Test class for CProcessor Factories based on the example myfirstCProcessorFactories 
 * 
...
public class TestCProcessorFactories extends TestCase{
	 ...
	 */
	@Test public void testProposeMessage(){
		Sally.start();
	...
	@Test public void testRefuseMessage(){
		...
		*/
		...
		assertEquals("REFUSE: Maybe someday"
			,Harry.receivedMsg);
	}

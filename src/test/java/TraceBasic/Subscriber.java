...
public class Subscriber extends BaseAgent{
	...
	public Subscriber(AgentID aid) throws Exception {
		...
		try {
			...
			System.out.println();
			System.out.println();
			System.out.println("[SUBSCRIBER " + this.getName() + "]: Now, we'll try to unpublish existing a tracing service which is not published:");
	...
	public void onTraceEvent(TraceEvent tEvent) {
		 ...
		 */
		System.out.println("[SUBSCRIBER " + this.getName() + "]: Event from " + tEvent.getOriginEntity().getAid().name + ": " + tEvent.getTracingService() + ": " + tEvent.getContent());
	}

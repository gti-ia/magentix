...
import mWaterWeb.bdConnection.mWaterBB_Performance2;
 ...
 *
 */
public class Main_performance2 {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length >= 8){
			...
			mWaterBB_Performance2 bb = new mWaterBB_Performance2();
			ConvJasonAgent staff_performance2 = new ConvJasonAgent(new AgentID("staff_performance2"), "./src/test/java/mWaterWeb/mwaterJasonAgents/staff_performance2.asl", arch,bb, connargs);
			...
			staff_performance2.getAgArch().setPerception(percept);

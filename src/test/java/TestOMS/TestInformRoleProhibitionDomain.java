...
public class TestInformRoleProhibitionDomain {
	...
	public void testInformRoleProhibitionDomain1() throws Exception {
		...
		dbA.executeSQL("INSERT INTO normList (idunitList, normName, iddeontic, idtargetType, targetValue, idactionNorm, normContent, normRule) " +
				"VALUES ((SELECT idunitList FROM unitList WHERE unitName = 'jerarquia'),'prohibidoVerInformacionRoleJerarquia', (SELECT iddeontic FROM deontic WHERE deonticdesc = 'f'), (SELECT idtargetType FROM " +
				...
				"'informRole' AND numParams = 3), '@prohibidoVerInformacionRoleJerarquia[f,<positionName:subordinate>,informRole(_,jerarquia,_),_,_]',"
				+ "'informRole(_,jerarquia,_)')");
		dbA.executeSQL("INSERT INTO actionNormParam (idnormList, idactionNorm, value) VALUES ((SELECT idnormList FROM normList WHERE normName = 'prohibidoVerInformacionRoleJerarquia'), (SELECT idactionNorm FROM actionNorm WHERE description = " +
		...
		omsProxy.informRole("jefe","jerarquia");

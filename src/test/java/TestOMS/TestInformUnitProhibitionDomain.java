...
public class TestInformUnitProhibitionDomain {
	...
	public void testInformUnitProhibitionDomain1() throws Exception {
		...
		dbA.executeSQL("INSERT INTO normList (idunitList, normName, iddeontic, idtargetType, targetValue, idactionNorm, normContent, normRule) " +
				"VALUES ((SELECT idunitList FROM unitList WHERE unitName = 'equipo'),'prohibidoVerInformacionUnidadEquipo', (SELECT iddeontic FROM deontic WHERE deonticdesc = 'f'), (SELECT idtargetType FROM " +
				...
				"'informUnit' AND numParams = 2), '@prohibidoVerInformacionUnidadEquipo[f,<agentName:pruebas>,informUnit(equipo,_),_,_]',"
				+ "'informUnit(equipo,_)')");
		dbA.executeSQL("INSERT INTO actionNormParam (idnormList, idactionNorm, value) VALUES ((SELECT idnormList FROM normList WHERE normName = 'prohibidoVerInformacionUnidadEquipo'), (SELECT idactionNorm FROM actionNorm WHERE description = " +
				"'informUnit' AND numParams = 2), 'equipo')");
		dbA.executeSQL("INSERT INTO actionNormParam (idnormList, idactionNorm, value) VALUES ((SELECT idnormList FROM normList WHERE normName = 'prohibidoVerInformacionUnidadEquipo'), (SELECT idactionNorm FROM actionNorm WHERE description = " +
				"'informUnit' AND numParams = 2), '_')");
		//----------------------------------------------------------------------------------------------------------------//
	...
	@Test(timeout = 5 * 60 * 1000, expected=ForbiddenNormException.class)
	public void testInformUnitProhibitionDomain2() throws Exception {
		...
		dbA.executeSQL("INSERT INTO normList (idunitList, normName, iddeontic, idtargetType, targetValue, idactionNorm, normContent, normRule) " +
				"VALUES ((SELECT idunitList FROM unitList WHERE unitName = 'jerarquia'),'prohibidoVerInformacionUnidadJerarquia', (SELECT iddeontic FROM deontic WHERE deonticdesc = 'f'), (SELECT idtargetType FROM " +
				...
				"'informUnit' AND numParams = 2), '@prohibidoVerInformacionUnidadJerarquia[f,<positionName:supervisor>,informUnit(jerarquia,Agent),playsRole(Agent,jefe,jerarquia),_]',"
				+ "'informUnit(jerarquia,Agent):-playsRole(Agent,jefe,jerarquia)')");
		dbA.executeSQL("INSERT INTO actionNormParam (idnormList, idactionNorm, value) VALUES ((SELECT idnormList FROM normList WHERE normName = 'prohibidoVerInformacionUnidadJerarquia'), (SELECT idactionNorm FROM actionNorm WHERE description = " +

...
public class TestAllocateRoleProhibitionDomain {
	...
	public void testAllocateRoleProhibitionDomain1() throws Exception {
		...
		dbA.executeSQL("INSERT INTO normList (idunitList, normName, iddeontic, idtargetType, targetValue, idactionNorm, normContent, normRule) " +
				"VALUES ((SELECT idunitList FROM unitList WHERE unitName = 'plana'),'prohibidoAsignarRol', (SELECT iddeontic FROM deontic WHERE deonticdesc = 'f'), (SELECT idtargetType FROM " +
				...
				"'allocateRole' AND numParams = 4), '@prohibidoAsignarRol[f,<agentName:pruebas>,allocateRole(_,plana,_,pruebas),isAgent(pruebas) & playsRole(pruebas,_,plana),_]',"
				+ "'allocateRole(_,plana,_,pruebas):-isAgent(pruebas) & playsRole(pruebas,_,plana)')");
		dbA.executeSQL("INSERT INTO actionNormParam (idnormList, idactionNorm, value) VALUES ((SELECT idnormList FROM normList WHERE normName = 'prohibidoAsignarRol'), (SELECT idactionNorm FROM actionNorm WHERE description = " +
	...
	@Test(expected=ForbiddenNormException.class)
	public void testAllocateRoleProhibitionDomain2() throws Exception {
		...
		dbA.executeSQL("INSERT INTO normList (idunitList, normName, iddeontic, idtargetType, targetValue, idactionNorm, normContent, normRule) " +
				"VALUES ((SELECT idunitList FROM unitList WHERE unitName = 'equipo'),'prohibidoAsignarRol', (SELECT iddeontic FROM deontic WHERE deonticdesc = 'f'), (SELECT idtargetType FROM " +
				"targetType WHERE targetName = 'agentName'), -1, (SELECT idactionNorm FROM actionNorm WHERE description = " +
				"'allocateRole' AND numParams = 4), '@prohibidoAsignarRol[f,<agentName:_>,allocateRole(_,equipo,_,Agent),isAgent(Agent) & playsRole(Agent,_,equipo),_]',"
				+ "'allocateRole(_,equipo,_,Agent):-isAgent(Agent) & playsRole(Agent,_,equipo)')");
		dbA.executeSQL("INSERT INTO actionNormParam (idnormList, idactionNorm, value) VALUES ((SELECT idnormList FROM normList WHERE normName = 'prohibidoAsignarRol'), (SELECT idactionNorm FROM actionNorm WHERE description = " +
				"'allocateRole' AND numParams = 4), '_')");
		dbA.executeSQL("INSERT INTO actionNormParam (idnormList, idactionNorm, value) VALUES ((SELECT idnormList FROM normList WHERE normName = 'prohibidoAsignarRol'), (SELECT idactionNorm FROM actionNorm WHERE description = " +
	...
	@Test(expected=ForbiddenNormException.class)
	public void testAllocateRoleProhibitionDomain3() throws Exception {
		...
		dbA.executeSQL("INSERT INTO normList (idunitList, normName, iddeontic, idtargetType, targetValue, idactionNorm, normContent, normRule) " +
				"VALUES ((SELECT idunitList FROM unitList WHERE unitName = 'jerarquia'),'prohibidoAsignarRol', (SELECT iddeontic FROM deontic WHERE deonticdesc = 'f'), (SELECT idtargetType FROM " +
				...
				"'allocateRole' AND numParams = 4), '@prohibidoAsignarRol[f,<positionName:supervisor>,allocateRole(_,jerarquia,_,Agent),isAgent(Agent) & playsRole(Agent,Role,jerarquia) & hasPosition(Role,jerarquia,supervisor),_]',"
				+ "'allocateRole(_,jerarquia,_,Agent):-isAgent(Agent) & playsRole(Agent,Role,jerarquia) & hasPosition(Role,jerarquia,supervisor)')");
		dbA.executeSQL("INSERT INTO actionNormParam (idnormList, idactionNorm, value) VALUES ((SELECT idnormList FROM normList WHERE normName = 'prohibidoAsignarRol'), (SELECT idactionNorm FROM actionNorm WHERE description = " +
				"'allocateRole' AND numParams = 4), '_')");
		dbA.executeSQL("INSERT INTO actionNormParam (idnormList, idactionNorm, value) VALUES ((SELECT idnormList FROM normList WHERE normName = 'prohibidoAsignarRol'), (SELECT idactionNorm FROM actionNorm WHERE description = " +

...
public class TestInformAgentRoleProhibitionDomain {
	...
	public void testInformAgentRoleProhibitionDomain1() throws Exception {
		...
		dbA.executeSQL("INSERT INTO normList (idunitList, normName, iddeontic, idtargetType, targetValue, idactionNorm, normContent, normRule) " +
				...
				"'informAgentRole' AND numParams = 2), '@prohibidoVerRolesJerarquia[f,<positionName:subordinate>,informAgentRole(RequestedAgent,Agent),_,_]',"
				+ "'informAgentRole(RequestedAgent,Agent)')");
		...
		omsProxy.informAgentRole("pruebas2");

		fail("Should have return an exception, product of a informAgentRole not allowed.");

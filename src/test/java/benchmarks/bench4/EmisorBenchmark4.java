...
public class EmisorBenchmark4 extends SingleAgent {
	...
	int nreceptor = Integer.parseInt(this.getName().substring(6)); // nombre
																	// d'agent
	int nmsg = 0;
	long t1, t2, tot = 0;

	public EmisorBenchmark4(AgentID aid, Connection connection, int nmsgtot,

...
public class Lanzadera {
	 ...
	 * "Emisor" ,   <------ 1
    	nombre completo 2
    	nmsgtot,	//nombre total de missatges a enviar   <------ 3
	...
	public static void main(String args[])
	{
		...
		{
			System.out.println("Error, Selecciones Emisor, Receptor o controlador como primer arguemento");
		}
	}

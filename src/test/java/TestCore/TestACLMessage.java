...
public class TestACLMessage extends TestCase {
	 ...
	 * 
	 * More attributes of ALCMessage could be
	 ...
	 * 
	 * 
	 * Test gerReceiver() with more than one receiver
	...
	/**
	 * Testing ACLMessage addReceiver()
	 * adding an existing Agent
	 * 
	 * When adding an existing agent
	 * addReceiver returns -1, if not 1
	 * 
	 */
	...
	{	
		...
		assertEquals(msg.toString(), msg2.toString());//Change this when equals method is implemented
	}
	...
	{		
		...
		assertEquals(replyMsg.getReceiver().toString(), msg.getSender().toString());
		...
		assertEquals(replyMsg.getExchangeHeaders(), new HashMap<String, String>());
	}
	...
	{	
		...
		assertEquals(templateMsg.getSender().toString(), msg.getSender().toString());
	 ...
	 * 
	 * 
	 * The execution flow returns true
	 * Test created throw reflection 
	 * due to it is a private method
	 */
	...
	{	
	    ...
	    Method m = null;
		try {
			m = msg.getClass().getDeclaredMethod("headersAreEqual", parameterTypes);
	 ...
	 *
	 * Get tested when content == null & byteSequenceContent == null
	 * also tested when only content != null 
	 * @throws IOException 
	 */
	 ...
	 *
	 * Returns the integer of the Performative or
	 * -1 if it is not a valid performative
	 */
	 ...
	 *
	 * Returns the String of the Performative or
	 * perfomative "NOT UNDERSTOOD" if it is not 
	 * a valid performative
	 */
	...
	{	
		...
		String msgString = msg.toString();
		String [] msgArray = msgString.split("#");	//Msg separated by # to count the correnct number of terms in the msg
	 ...
	 * Testing ACLMessage fromString()
	 *
	 * FromString tested when ACLMessage atributes
	 * are empty, in this case toString must be
	 * equal and messages
	 * 
	 * 
	 *
	...
	{	
		...
		System.out.println(msgFrom.getSender());
	 ...
	 *
	 * FromString tested when ACLMessage atributes
	 * are null, in this case toString are equals
	 ...
	 * Testing ACLMessage equals()
	 *
	 * Equals tested when Object parameter
	 * is not an instance of ACLMessage
	 */

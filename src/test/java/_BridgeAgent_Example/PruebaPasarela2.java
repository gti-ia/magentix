...
public class PruebaPasarela2 {
	...
	//	Connection con = new Connection();
     //   con.connect("gtiiaprojects2.dsic.upv.es", 5672, "test", "guest", "guest",false);
  ...
  try{
	  ...
	  BridgeAgentInOut agenteInOut = new BridgeAgentInOut(new AgentID("BridgeAgentInOut", "qpid", "localhost","8080"));
       /*
        * agenteInOut interactua con agenteOutIn
        */
        BridgeAgentOutIn agenteOutIn = new BridgeAgentOutIn(new AgentID("BridgeAgentOutIn", "qpid", "localhost","8080"));
        
        /*
         * agente1 interactua con el agenteInOut
         */
        AgenteSergio agente1 = new AgenteSergio(new AgentID("agentehola", "qpid", "localhost","8080"));
       /*

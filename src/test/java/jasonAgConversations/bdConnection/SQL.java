...
public class SQL 
{
	...
	public static final String GET_WATERRIGHTS_BY_OWNER(String owner)
	{
		...
		String result =  "SELECT mWaterDB.waterright.* FROM mWaterDB.waterright, mWaterDB.generalwaterright "+

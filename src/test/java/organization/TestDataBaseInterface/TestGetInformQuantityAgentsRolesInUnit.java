...
public class TestGetInformQuantityAgentsRolesInUnit extends TestCase {
	...
	protected void setUp() throws Exception {
	    ...
	    m = DataBaseInterface.class.getDeclaredMethod("getInformQuantityAgentsRolesInUnit", parameterTypes);
	...
	@Test
	public void testGetInformQuantityAgentsRolesInUnit1() {
		
		/**---------------------------------------------------------------------------------------------
		 * --			1.	
		 * --				- All parameters are correct
		 * --				- Unit has several roles and 2 agents
	...
	@Test
	public void testGetInformQuantityAgentsRolesInUnit2() {
	...
	@Test
	public void testGetInformQuantityAgentsRolesInUnit3() {

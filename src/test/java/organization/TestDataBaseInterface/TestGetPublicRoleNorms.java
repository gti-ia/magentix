...
public class TestGetPublicRoleNorms extends TestCase {
	...
	protected void setUp() throws Exception {
	    ...
	    m = DataBaseInterface.class.getDeclaredMethod("getPublicRoleNorms", parameterTypes);
	...
	public void testGetPublicRoleNorms1() {
		...
		try {	
			...
			assertEquals("The message should be:", "[["+ eNorm2 +", "+ unit +", roleName, "+ eRoleMember +"]]", result.toString());
	...
	public void testGetPublicRoleNorms2() {
		...
		try {	
		    ...
		    ArrayList<ArrayList<String>> result = (ArrayList<ArrayList<String>>) m.invoke(dbI, parameters);
			assertEquals("The message should be:", "[["+ eNorm +", "+ unit +", roleName, _]]", result.toString());
	...
	public void testGetPublicRoleNorms3() {
		 ...
		 * --			3.	
		 * --				- All parameters are correct
		 * --				- Norm isn't associated to any role
		 * --				- Show correctly the information
		 * ---------------------------------------------------------------------------------
		 */

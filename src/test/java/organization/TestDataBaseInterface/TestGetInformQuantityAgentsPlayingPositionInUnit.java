...
public class TestGetInformQuantityAgentsPlayingPositionInUnit extends TestCase {
	...
	protected void setUp() throws Exception {
	    ...
	    m = DataBaseInterface.class.getDeclaredMethod("getInformQuantityAgentsPlayingPositionInUnit", parameterTypes);
	...
	@Test
	public void testGetInformQuantityAgentsPlayingPositionInUnit1() {
		
		/**---------------------------------------------------------------------------------------------
		 * --			1.	
		 * --				- All parameters are correct
		 * --				- Unit has several roles and 2 agents playing roles with
	...
	@Test
	public void testGetInformQuantityAgentsPlayingPositionInUnit2() {
		
		/**---------------------------------------------------------------------------------------------
		 * --			2.	
		 * --				- All parameters are correct
		 * --				- Unit has several roles, 2 agents playing roles with
		 * --				  position field equal to member and 1 agent play role with visibility field
		 * --				  equal to private
		 * --				- Show correctly the information
		 * ---------------------------------------------------------------------------------------------
		 */
	...
	@Test
	public void testGetInformQuantityAgentsPlayingPositionInUnit3() {
		
		/**---------------------------------------------------------------------------------------------
		 * --			3.	
		 * --				- All parameters are correct
		 * --				- Unit has several roles, but not agents associated
		 * --				- Show correctly the information
		 * ---------------------------------------------------------------------------------------------
		 */
	...
	@Test
	public void testGetInformQuantityAgentsPlayingPositionInUnit4() {
	...
	@Test
	public void testGetInformQuantityAgentsPlayingPositionInUnit5() {

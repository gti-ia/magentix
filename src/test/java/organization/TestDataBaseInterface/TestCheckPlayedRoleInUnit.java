...
public class TestCheckPlayedRoleInUnit {
	...
	public void setUp() throws Exception {
	    ...
	    m = DataBaseInterface.class.getDeclaredMethod("checkPlayedRoleInUnit", parameterTypes);
	...
	@Test(timeout = 5 * 1000)
	public void testCheckPlayedRoleInUnit1() {
		
		/**---------------------------------------------------------------------------------
		 * --			1.	
		 * --				- All parameters are correct
		 * --				- Role is played by some agent within unit
		 * --				- Check if role within unit is played by some agent
		 * ---------------------------------------------------------------------------------
		 */
		...
		try {	
			...
			assertTrue("Role R in unit U isn't played by any agent of the unit.", result);
	...
	@Test(timeout = 5 * 1000)
	public void testCheckPlayedRoleInUnit2() {
		
		/**---------------------------------------------------------------------------------
		 * --			2.	
		 * --				- All parameters are correct
		 * --				- Role isn't played by some agent within unit
		 * --				- Check if role within unit is played by some agent
		 * ---------------------------------------------------------------------------------
		 */
		...
		try {	
			...
			boolean result = (Boolean) m.invoke(dbI, parameters);
			assertFalse("Role R in unit U is played by any agent of the unit.", result);

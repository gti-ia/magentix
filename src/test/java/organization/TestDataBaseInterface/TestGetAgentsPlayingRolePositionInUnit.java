...
public class TestGetAgentsPlayingRolePositionInUnit extends TestCase {
	...
	protected void setUp() throws Exception {
	    ...
	    m = DataBaseInterface.class.getDeclaredMethod("getAgentsPlayingRolePositionInUnit", parameterTypes);
	...
	public void testGetAgentsPlayingRolePositionInUnit1() {
		...
		try {	
			...
			assertEquals("The message should be:", "["+ eAgent +"]", result.toString());

...
public class TestGetInformQuantityAgentsPlayingVisibilityPositionInUnit extends TestCase {
	...
	protected void setUp() throws Exception {
	    ...
	    m = DataBaseInterface.class.getDeclaredMethod("getInformQuantityAgentsPlayingVisibilityPositionInUnit", parameterTypes);
	...
	public void testGetInformQuantityAgentsPlayingVisibilityPositionInUnit2() {
		...
		try {	
			...
			int result = (Integer) m.invoke(dbI, parameters);
			assertEquals("The message should be:", 1, result);

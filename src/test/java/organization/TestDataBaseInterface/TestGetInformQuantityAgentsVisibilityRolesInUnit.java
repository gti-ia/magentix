...
public class TestGetInformQuantityAgentsVisibilityRolesInUnit {
	...
	public void setUp() throws Exception {
	    ...
	    m = DataBaseInterface.class.getDeclaredMethod("getInformQuantityAgentsVisibilityRolesInUnit", parameterTypes);
	...
	public void testGetInformQuantityAgentsVisibilityRolesInUnit1() {
		 ...
		 * --				- Unit has several roles, 1 agent with visibility equal to public

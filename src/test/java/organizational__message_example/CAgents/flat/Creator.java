...
public class Creator extends CAgent {
	...
	//In this state the agent creator joint unit, deallocate the role of the agents inside the unit
	//calculin, remove the role operador and manager, finally remove unit calculin and externa.
